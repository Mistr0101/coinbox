...
function bxc_checkout($settings) {
    ...
    if ($checkout_type == 'popup') {
        echo '<div class="bxc-btn bxc-btn-popup"><img src="' . BXC_URL . 'media/icons.svg" alt="" />' . bxc_(bxc_settings_get('button-text', 'Pay now')) . '</div><div class="bxc-popup-overlay"></div>';
    }
    $css = false;
